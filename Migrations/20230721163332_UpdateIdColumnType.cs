        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Transportadora = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NumeroRastreamento = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InformacoesEntrega", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaminhoImagens = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Faturas_Clientes_Id_Cliente",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ClienteId = table.Column<int>(type: "int", nullable: true),
                    MoradaEntrega = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ValorPorItem = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ValorTotal = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    PagamentoRealizado = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    Status = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DataEncomenda = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ...
                    MetodoPagamento = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    QuantidadeItens = table.Column<int>(type: "int", nullable: true),
                    ValorDesconto = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ValorEnvio = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    InformacoesEntregaId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Encomendas_EnderecoEntrega_EnderecoEntregaId",
                        column: x => x.EnderecoEntregaId,
                        principalTable: "EnderecoEntrega",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Encomendas_InformacoesEntrega_InformacoesEntregaId",
                        column: x => x.InformacoesEntregaId,
                        principalTable: "InformacoesEntrega",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stock_Fornecedores_Fornecedor",
                        column: x => x.Fornecedor,
                        principalTable: "Fornecedores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stock_Produtos_Produto",
                        column: x => x.Produto,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fatura_Detalhes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Fatura_Detalhes_Faturas_Id_Fatura",
                        column: x => x.Id_Fatura,
                        principalTable: "Faturas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Fatura_Detalhes_Produtos_Id_Produto",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncomendasId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemEncomenda", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemEncomenda_Encomendas_EncomendasId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Encomendas_EnderecoEntregaId",
                table: "Encomendas",
                column: "EnderecoEntregaId");

            migrationBuilder.CreateIndex(
                name: "IX_Encomendas_InformacoesEntregaId",
                table: "Encomendas",
                column: "InformacoesEntregaId");

            migrationBuilder.CreateIndex(
                name: "IX_Fatura_Detalhes_Id_Fatura",
                table: "Fatura_Detalhes",
                column: "Id_Fatura");

            migrationBuilder.CreateIndex(
                name: "IX_Fatura_Detalhes_Id_Produto",
                table: "Fatura_Detalhes",
                column: "Id_Produto");

            migrationBuilder.CreateIndex(
                name: "IX_Faturas_Id_Cliente",
                table: "Faturas",
                column: "Id_Cliente");

            migrationBuilder.CreateIndex(
                name: "IX_ItemEncomenda_EncomendasId",
                table: "ItemEncomenda",
                column: "EncomendasId");

            migrationBuilder.CreateIndex(
                name: "IX_Stock_Fornecedor",
                table: "Stock",
                column: "Fornecedor");

            migrationBuilder.CreateIndex(
                name: "IX_Stock_Produto",
                table: "Stock",
                column: "Produto");
