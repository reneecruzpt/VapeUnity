...
{
    public class Produtos1Controller : Controller
    {
        private readonly Contexto _context;

        public Produtos1Controller(Contexto context)
        {
            _context = context;
        }
        ...
        // GET: Produtos1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Produtos1/Create
