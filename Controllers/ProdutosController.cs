...
namespace VapeUnity.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Preco,Categoria,Disponibilidade")] Produtos produtos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Preco,Categoria,Disponibilidade")] Produtos produtos)
        {
            if (id != produtos.Id)
            {
                return NotFound();
